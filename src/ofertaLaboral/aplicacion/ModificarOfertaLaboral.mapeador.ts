...
export class ModificarOfertaLaboralMapeador {
    //Convertimos a DTO Crear, entidad Oferta Laboral
    public static aDTO(
        entidad: OfertaLaboral
    ): Resultado<ModificarOfertaLaboralDTO> {
        ...
        let dto: ModificarOfertaLaboralDTO = {
        ...
        return Resultado.ok<ModificarOfertaLaboralDTO>(dto);
    }
}
